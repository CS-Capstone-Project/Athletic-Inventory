...
<div class="container">
    ...
    <button type="submit" name="searchTable"><i class="fa-solid fa-magnifying-glass">
    </i></button>
	</form>
        <!--Trigger the modal-->
...
<input type="hidden" name="sportName" value="<?php echo $sportName;?>">
		...
		<input type="hidden" name="tableName" value="<?php echo $tableName;?>">
                <input type="hidden" name="type" value="Misc">
                                   ...
                                   <button type="submit" name = "addMisc" class="btn buttonaddMis" data-toggle="modal" data-target="#addmisc" onclick="toastr.success('Added Miscellaneous!')">Add <i class="fa-solid fa-square-plus"></i></button>
                                   <button type="button" class="btn buttoncancel" data-dismiss="modal">Cancel <i class="fa-solid fa-rectangle-xmark"></i></button> 
				</form>
                               </div>
                           </div>
...
<footer class="container-fluid text-center">
 ...
 <!--Edit Clothing modal*********************************************************************************************************************-->
    ...
    <input type="hidden" name="type" value="Clothing">
                                    ...
                                    <button type="submit" class="btn buttoneditconfirm"  name = "editClothingItem">Save Changes <i class="fa-solid"></i></button>
                                    <button type="button" class="btn buttoncancel" data-dismiss="modal">Cancel <i class="fa-solid fa-rectangle-xmark"></i></button>
                                    <button type="submit" class="btn buttondelete"  name = "deleteItem">Delete <i class="fa-solid"></i></button>
 ...
 <div class="modal-footer">
                               <div class="col-md-12 text-center">
                                   ...
                                   <button type="submit" class="btn buttoneditconfirm" name = "editMisc">Save Changes <i class="fa-solid"></i></button>
                                   <button type="button" class="btn buttoncancel" data-dismiss="modal">Cancel <i class="fa-solid fa-rectangle-xmark"></i></button> 
                                   <button type="submit" class="btn buttondelete"  name = "deleteItem">Delete <i class="fa-solid"></i></button>
				</form>
                               </div>
...
<input type="hidden" name="sportName" value="<?php echo $sportName;?>">
		...
		<input type="hidden" name="tableName" value="<?php echo $tableName;?>">
                <input type="hidden" name="type" value="Shoes">
                                   ...
                                   <button type="submit" class="btn buttoneditconfirm" name = "editShoes">Save Changes <i class="fa-solid"></i></button>
                                   <button type="button" class="btn buttoncancel" data-dismiss="modal">Cancel <i class="fa-solid fa-rectangle-xmark"></i></button>
                                   <button type="submit" class="btn buttondelete"  name = "deleteItem">Delete <i class="fa-solid"></i></button> 
